...
class Ring:
    ...
    def _connect_cells(self):
        ...
        for target in self.cells:
            ...
            # Add another synapse
            source2_gid = (target._gid - 3 + self._N) % self._N
            nc2 = pc.gid_connect(source2_gid, target.syn)
            nc2.weight[0] = self._syn_w
            nc2.delay = self._syn_delay
            target._ncs.append(nc2)

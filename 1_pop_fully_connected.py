...
# In[]
# Create a population
excitatory = RandomPopulation(N=200, N_interconnect=199, probability_tau=20, syn_w=0.00043/199)
excitatory.add_current_random_cells(delay=50, duration=300, amp=0.04)
